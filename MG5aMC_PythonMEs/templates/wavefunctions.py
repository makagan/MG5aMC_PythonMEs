...
def ixxxxx(p,fmass,nhel,nsf):
    ...
    def fmass_nonzero_pp_nonzero(p,fmass,nhel,nsf, nh, pp):
        ...
        chi1 = np.where(pp3 == 0.,
                          complex(-1.0*nh,0.),
                          complex(nh*p[1]/sqrt(2.*pp*pp3), p[2]/sqrt(2.*pp*pp3)) )
    ...
    def fmass_zero(p,fmass,nhel,nsf, nh):
        ...
        chi1 = np.where(sqp0p3 == 0. ,
                           complex(-1.0*nhel*sqrt(2.*p[0]),0.),
    ...
    fi2345 = np.where(fmass != 0. , fmass_nonzero(p,fmass,nhel,nsf, nh), fmass_zero(p,fmass,nhel,nsf, nh) )
...
def oxxxxx(p,fmass,nhel,nsf):
    ...
    def fmass_nonzero_pp_nonzero(p,fmass,nhel,nsf, nh, pp):
        ...
        chi1 = np.where(pp3 == 0. , complex(-1.0*nh,0.) , complex(nh*p[1]/sqrt(2.*pp*pp3), -p[2]/sqrt(2.*pp*pp3)))
        chi0 = complex(sqrt(pp3*0.5/pp))
    ...
    fo2345 = np.where(fmass != 0. , fmass_nonzero(p,fmass,nhel,nsf, nh), fmass_zero(p,fmass,nhel,nsf, nh) )
